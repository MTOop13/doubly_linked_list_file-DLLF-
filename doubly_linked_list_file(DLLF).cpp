...
int main() {
	...
	ifstream file;
	file.open("C:\\Users\\Mohammed Hidarah\\Desktop\\file.txt");
	string line;
	...
	/*do{
		...
		switch(choice){
			...
			case 2:{
				...
				cout<<"Enter the number of the line : ";
				cin>>num;
				myfile[num-1].display();
				cout<<"The number of words in this line is : "<<myfile[num-1].size()<<endl;
				cout<<"The number of characters in the file is : "<<myfile[num-1].chars_count()<<endl;
				break;
			}
			case 3:{
